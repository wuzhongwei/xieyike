<template>
	<view class="app">
		<view class="page-tit row">
			<text class="f-m">修改密码</text>
		</view>
		<view class="input-wrap pwd-wrap row b-b">
			<text class="mix-icon icon-mima"></text>
			<input class="input" v-model="password" :password="!showPwd" type="number" maxlength="6" placeholder="请输入新密码" placeholder-style="color:#999;font-size:30rpx" />
		...
		<view class="input-wrap row b-b">
			...
			<input class="input" v-model="code" type="number" maxlength="13" placeholder="请输入手机号" placeholder-style="color:#999;font-size:30rpx" />
		</view>
		<view class="input-wrap row b-b">
			...
			<mix-code templateCode="SMS_194050994" action="修改密码"></mix-code>
		</view>
