...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"yixieke","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    ...
    setStateAttr: function setStateAttr(state, param) {
      if (typeof state[param.key] === 'object') {
        state[param.key] = _objectSpread(_objectSpread({},
        state[param.key]),
        param.val);
  ...
  actions: {
    //更新用户信息
    getUserInfo: function getUserInfo(_ref) {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var state, commit;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:state = _ref.state, commit = _ref.commit;
                (0, _plugins.request)({
...
var request = function request(options, ext) {
  return new Promise(function (resolve, reject) {
    ...
    {var _ref2 = _slicedToArray(_ref, 2),error = _ref2[0],data = _ref2[1].data;
...
var uploadFile = function uploadFile(options, ext) {
  return new Promise(function (resolve, reject) {
    ext = _objectSpread(_objectSpread({},
    ext), {}, {
      isShowLoading: true });

    options.data = _objectSpread({},
    options.data);

    ext.isShowLoading && uni.showLoading();
    uni.uploadFile({
      url: "".concat(baseUrl).concat(options.url), //仅为示例，非真实的接口地址
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _plugins = __webpack_require__(/*! @/common/js/plugins */ 16);var _default =

{
  ...
  methods: {
    ...
    /**
        ...
        */
    $uploadFile: function $uploadFile(options) {var ext = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { isShowLoading: true };
      if (ext.login && !this.$util.isLogin()) {
        return Promise.reject();
      }
      (0, _plugins.uploadFile)(options, ext);
    },
    ...
    imageOnLoad: function imageOnLoad(data, key) {
      setTimeout(function () {
        // this.$set(data, 'loaded', true);
      }, 100);
    },
    showConfirm: function showConfirm(key) {var _this2 = this;
      this.$util.throttle(function () {
        _this2.$refs[key].open();
      }, 200);
    },
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _message = _interopRequireDefault(__webpack_require__(/*! ./message.js */ 511));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/***/ 519:
/*!*******************************************************************************!*\
  !*** E:/yixieke/uni_modules/uni-easyinput/components/uni-easyinput/common.js ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 576:
/*!*************************************************************!*\
  !*** E:/yixieke/components/jyf-parser/libs/MpHtmlParser.js ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
 ...
 * @listens MIT
 */
var cfg = __webpack_require__(/*! ./config.js */ 577),
blankChar = cfg.blankChar,
CssHandler = __webpack_require__(/*! ./CssHandler.js */ 578),
...
/***/ 577:
/*!*******************************************************!*\
  !*** E:/yixieke/components/jyf-parser/libs/config.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 578:
/*!***********************************************************!*\
  !*** E:/yixieke/components/jyf-parser/libs/CssHandler.js ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 607:
/*!**********************************************************************!*\
  !*** E:/yixieke/uni_modules/uni-icons/components/uni-icons/icons.js ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
